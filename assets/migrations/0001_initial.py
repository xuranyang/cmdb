# Generated by Django 2.2.3 on 2021-05-22 23:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='admin', to='login.User', verbose_name='资产管理员')),
                ('approved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='approved_by', to='login.User', verbose_name='批准人')),
            ],
            options={
                'verbose_name': '资产总表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.SmallIntegerField(choices=[(0, '其它'), (1, '新增资产'), (2, '修改资产'), (3, '删除资产')], default=4, verbose_name='事件类型')),
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='login.User', verbose_name='事件执行人')),
            ],
            options={
                'verbose_name': '事件纪录',
